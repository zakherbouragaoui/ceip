      ...
      <div style={{ padding: "40px 64px", display: "flex", flexDirection: "column" }}>
        ...
        <div style={{ flex: 1, display: "grid", placeItems: "center" }}>
          <div style={{ width: "100%", maxWidth: 400 }}>
            ...
            <p className="text-soft" style={{ marginBottom: 28 }}>Pick up where you left off.</p>
            ...
            <form onSubmit={handleSubmit}>
              ...
              <div style={{ marginBottom: 8 }}>
                <label className="label row justify-between">
                  Password
                  <a className="text-xs" style={{ color: "var(--forest)" }}>Forgot?</a>
                </label>
                <input
                  className="input"
                  type="password"
              ...
              <Btn variant="primary" style={{ width: "100%", justifyContent: "center", marginTop: 12, padding: 12 }} type="submit">
                {loading ? "Signing in…" : <>Sign in <I.ArrowRight size={16} /></>}
              </Btn>
            </form>

            <div className="text-sm text-soft" style={{ marginTop: 24, textAlign: "center" }}>
              New to CEIP?{" "}
              <Link href="/register" style={{ color: "var(--forest)", fontWeight: 500 }}>Create account</Link>
            </div>
          </div>
        </div>
